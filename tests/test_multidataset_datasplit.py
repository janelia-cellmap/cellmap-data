...
class TestCellMapDataSplit:
    ...
    def test_initialization_with_dict(self, datasplit_paths):
        ...
        dataset_dict = {
            "train": [
                {"raw": tc["raw_path"], "gt": tc["gt_path"]}
                for tc in train_configs
            ],
            "validate": [
                {"raw": vc["raw_path"], "gt": vc["gt_path"]}
    ...
    def test_train_validation_split(self, datasplit_paths):
        ...
        assert hasattr(datasplit, "train_datasets") or hasattr(datasplit, "train_datasets_combined")
        assert hasattr(datasplit, "validation_datasets") or hasattr(datasplit, "validation_datasets_combined")
    ...
    def test_classes_parameter(self, datasplit_paths):
        ...
        dataset_dict = {
            "train": [{"raw": tc["raw_path"], "gt": tc["gt_path"]} for tc in train_configs],
            "validate": [{"raw": vc["raw_path"], "gt": vc["gt_path"]} for vc in val_configs],
        }
