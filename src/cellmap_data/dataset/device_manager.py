...
class DeviceManager:
    ...
    def _check_device_availability(self) -> None:
        ...
        logger.debug(f"Device availability: CUDA={self._cuda_available}, MPS={self._mps_available}")
    ...
    def to_device(self, tensor: torch.Tensor, non_blocking: bool = False) -> torch.Tensor:
        ...
        try:
            ...
            logger.warning(f"Failed to move tensor to {self._device}, keeping on {tensor.device}: {e}")
            return tensor
